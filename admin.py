...
def mostrar_admin():
    ...
    # Inicializar el control de autenticación de sesión
    ...
    if not st.session_state["autenticado"]:
        ...
        # =====================================================================
        # PANEL DE CONTROL DIRECTO (SOLO VISIBLE SI ESTÁ AUTENTICADO)
        # =====================================================================
        ...
        with st.form("form_diesel_manual"):
            ...
            st.form_submit_button("Guardar Diesel en CSV")
            
            if st.session_state.get("form_diesel_manual_submit") or st.form_submit_button("Guardar Diesel en CSV"):
                # Nota: duplicar el string del submit button dentro del if evalúa la acción del formulario
                pass
                
            # Solución directa para capturar el botón correctamente dentro del context manager
